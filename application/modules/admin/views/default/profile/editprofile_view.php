<div class="row">
    ...
    <a href="<?php echo site_url('profile/'.$profile->id);?>" class="btn btn-success add-location" target="_blank">View Profile</a>
   <div style="clear:both;margin-top:20px;"></div>
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <?php echo $this->session->flashdata('msg_usertype'); ?>
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/updateprofile'); ?>" method="post">
                    ...
                    <?php }?>
                    <?php }?>
                    <input type="hidden" name="user_type_id" value="<?=$profile->user_type?>" />

				<?php  if(get_user_type_by_id($profile->user_type) != 'business'){ ?>
		...
		<?php  if(get_user_type_by_id($profile->user_type) != 'business'){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 col-lg-2 control-label">Bio</label>
			...
			<?php  if(get_user_type_by_id($profile->user_type) == 'business'){ ?>
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                ...
                                <select class="form-control" name="user_type">   
                                    ...
                                    <?php $sel=($curr_value=='3')?'selected="selected"':'';?>            
                                    <option value="3" <?php echo $sel;?>>Person</option>            
                                </select>            
                                <span class="help-inline">&nbsp;</span>
                            ...
                            <div class="alert alert-info" role="alert">Currently your account type is business. If you change the account type into personal you can't reverse.  </div>
