...
<div class="row">
  <div class="col-md-12">
   ...
   <div style="clear:both;margin-top:20px;"></div>
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> All Experience </h3>
        <div class="box-tool">
      ...
      <div class="box-content">       
        ...
        <table id="all-posts" class="table table-hover">
           ...
           <tbody>
        	<?php $i=1;foreach($experiences->result() as $row):?>
               <tr>
                  <td data-title="#" class="numeric"><?php echo $i;?></td>
                  <td data-title="" class="numeric"><a href="<?php echo site_url('admin/editexperience/'. $curr_page.'/'.$row->id);?>"><?php echo $row->company_name;?></a></td>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a href="<?php echo site_url('admin/editexperience/'. $curr_page.'/'.$row->id);?>"><?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/deleteexperience/'.$row->id);?>"><?php echo lang_key('delete');?></a></li>
                      </ul>
                    </div>
                  </td>
               </tr>
