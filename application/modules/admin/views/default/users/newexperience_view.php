...
<div class="row">	
  <div class="col-md-12">
   ...
   <div style="clear:both;margin-top:20px;"></div>
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> New Experience </h3>
        <div class="box-tool">
      ...
      <div class="box-content">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/addexperience/'.$curr_page.'/'.$userID);?>" method="post">
				 
                 <div class="form-group">
					<label class="col-sm-3 col-md-3 control-label">Company Name:</label>
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="company_name" value="<?php echo(set_value('company_name')!='')?set_value('company_name'):'';?>" placeholder="Company Name" class="form-control input-sm" >
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="location" value="<?php echo(set_value('location')!='')?set_value('location'):'';?>" placeholder="Location" class="form-control input-sm" >
                 ...
                 <div class="form-group">
					...
					<div class="col-sm-8 col-md-8 controls">
                    	<div class="col-md-5">  
                              <div class="col-md-6">             	
                       <?php $start_month=(set_value('start_month')!='')?set_value('start_month'):'';?>
                        ...
                        <div class="col-md-6"> 
                        <input type="text" name="start_year" value="<?php echo(set_value('start_year')!='')?set_value('start_year'):'';?>" placeholder="Start year"   class="form-control input-sm"  style="width:100px;" />
                      
                       </div>
                       </div>
                       <div class="col-md-1"> - </div>
                       <?php $current = (set_value('current')!='')?set_value('current'):'';?>
                       <div class="col-md-6">  
                       		 <div class="col-md-12">
                       		<div class="end_date" style=" <?php if($current == 'on'){ ?> display:none <?php }else{ ?>  <?php } ?>" > 
                        	<?php $end_month=(set_value('end_month')!='')?set_value('end_month'):'';?>
                        ...
                        <input type="text"  name="end_year" value="<?php echo(set_value('end_year')!='')?set_value('end_year'):'';?>" placeholder="End year"   class="form-control input-sm"  style="width:100px; float:left; margin-right:10px;" />
                        </div>
                        <div class="end_date_txt" style=" <?php if($current == 'on'){ ?><?php }else{ ?> display:none <?php } ?>"> 
                        	Present
                        </div>
                        ...
                        <input type="checkbox" id="present" name="current" <?php if($current == 'on'){ ?>  checked="checked" <?php } ?>  /> I currently work here 
                       </div>
