...
<div class="row">	
  <div class="col-md-12">
  	  <a href="<?php echo site_url('admin/neweducation/'.$curr_page);?>" class="btn btn-success add-location">Add New Education</a>
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> Edit Education </h3>
        <div class="box-tool">
      ...
      <div class="box-content">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/updateeducation/'.$curr_page.'/'.$userID);?>" method="post">
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-4 controls">
						<input type="text" name="school_name" value="<?php echo(set_value('school_name')!='')?set_value('school_name'):$education->school_name;?>" placeholder="School Name" class="form-control input-sm" >
			     ...
			     <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
					  <?php
					  	  $selected_s = (set_value('start_year')!='')?set_value('start_year'):$education->start_year;
                      ...
                      ?>  
                       <?php
					     $selected = (set_value('end_year')!='')?set_value('end_year'):$education->end_year;
						  $currently_selected = date('Y');                   
						  $earliest_year = 1950;                  
						  $latest_year = 2030;                 
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="degree" value="<?php echo(set_value('degree')!='')?set_value('degree'):$education->degree;?>" placeholder="Degree" class="form-control input-sm" >
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="study_field" value="<?php echo(set_value('study_field')!='')?set_value('study_field'):$education->study_field;?>" placeholder="Field of Study" class="form-control input-sm" >
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="grad" value="<?php echo(set_value('grad')!='')?set_value('grad'):$education->grad;?>" placeholder="Grade" class="form-control input-sm" >
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
                    	<textarea name="activities"  placeholder="Activities" class="form-control input-sm"><?php echo(set_value('activities')!='')?set_value('activities'):$education->activities;?></textarea>
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
                    <textarea name="description" placeholder="Description" class="form-control input-sm"><?php echo(set_value('description')!='')?set_value('description'):$education->description;?></textarea>                    						
