...
<?php if(isset($blog)){ 	$blog = $blog->row(); }	 ?>
  ...
  <a href="<?php echo site_url('admin/view_all_blogs');?>" class="btn btn-success add-location">View Blogs</a>
  <?php if(isset($blog)){?>
 	 <a href="<?php echo site_url('admin/add_blog');?>" class="btn btn-success add-location">Add Blog</a>
  <?php }?>
   <div style="clear:both;margin-top:20px;"></div>

	<form action="<?php echo site_url('admin/add_blog');?>" method="post">
      ...
      <div class="box-content">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 col-lg-5 controls">                    
                ...
                <iframe src="<?php echo site_url('admin/featuredimguploader');?>" style="border:0;margin:0;padding:0;height:130px;"></iframe>
                <span class="help-inline">&nbsp;</span>
            </div>          
        </div>
        <div class="clearfix"></div>
...
jQuery(document).ready(function(){
	...
	jQuery('#featured_photo_input').change(function(){
        ...
        if(val!='')
        {
          var src = base_url+'uploads/users/blog/thumbs/'+val;            
        }
        else
        {
