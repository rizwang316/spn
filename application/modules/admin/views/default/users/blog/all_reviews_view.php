...
<div class="row">
  ...
  <div class="col-md-12">
   ...
   <a href="<?php echo site_url('admin/view_all_blogs/'. $curr_page);?>" class="btn btn-success add-location"> << Back to blog list</a>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/deletecomment/'.$curr_page.'/'.$post_id.'/'.$row->id.'/');?>"><?php echo lang_key('delete');?></a></li>                          
                      </ul>
