...
<div class="row">
  ...
  <div class="col-md-12">
  <a href="<?php echo site_url('admin/add_video/'. $curr_page);?>" class="btn btn-success add-location">Add Video</a>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a class="" href="<?php echo site_url('admin/manage_video/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key('edit');?></a></li>                                                                         
                            
                          <li><a href="<?php echo site_url('admin/deletevideo/'.$curr_page.'/'.$row->id.'/');?>"><?php echo lang_key('delete');?></a></li>                          
                      </ul>
