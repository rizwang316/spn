...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your spn with SPN</h4>
          ...
          <div class="row" style="text-align:center">
              ...
              <form action="<?php echo site_url('admin/purchase/addkey');?>" method="POST" class="form-horaizontal">
                ...
                <input type="text" name="domain" value="<?php echo base_url();?>" class="form-control input-md-3" readonly>
                <label>Item id : </label>
