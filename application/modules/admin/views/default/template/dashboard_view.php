    ...
    function initialize() {
            ...
            if(map_data.posts.length > 0){
                for (i = 0; i < map_data.posts.length; i++) {
                    ...
                    var marker_label = '<i class="fa fa-map-marker  glyphicon glyphicon-map-marker"></i>';
...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Listed Business Locations<?php // echo lang_key('view_posts');?></h3>
                <div class="box-tool">
              ...
              <div class="col-md-12">
                ...
                <div class="tile">
                  ...
                  <p class="title">
                    ...
                    SPN Business Directory - Listing your local businesses
              ...
              <div class="col-md-12 tile-active">
                ...
                <div class="tile tile-blue">
                  ...
                  <p class="title">
                    ...
                    SPN Business Directory Admin

                  </p>

                  <p>

                      SPN Business Directory is the most complete and easy manageable Business Directory script
