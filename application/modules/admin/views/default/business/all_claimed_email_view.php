  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> <?php echo lang_key('claimed_business'); ?></h3>
        ...
        <?php }else{?>
           ...
           <tbody>
        	...
        	<?php $i=$start+1;foreach($posts->result() as $row):  
               ...
               // $detail_link = post_detail_url($row);
                ...
                $query = $CI->post_model->get_post_by_id($row->post_id);				 
                $post = $query->row();
          ...
          ?>
               ...
               <tr>
                  ...
                  <td data-title="<?php echo lang_key('title'); ?>" class="numeric"><?php echo $post->title;?></td>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a class="detail" id="<?php echo $row->id;?>" href="<?php // echo $detail_link;?>">
						  	<?php echo lang_key('detail'); ?></a></li>
                          <?php if(is_admin()){?>
                          <?php }?>
                      </ul>
