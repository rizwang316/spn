...
<?php if(isset($video)){ 	$video = $video->row(); }	 ?>
  <div class="col-md-12">
   <a href="<?php echo site_url('admin/business/view_all_video/'. $curr_page.'/'.$business_id);?>" class="btn btn-success add-location">Video List</a>
   <?php if(isset($id)){?>
    <a href="<?php echo site_url('admin/business/manage_video/'. $curr_page.'/'.$business_id);?>" class="btn btn-success add-location">Add Video</a>
    <?php } ?>
   <div style="clear:both;margin-top:20px;"></div>

	<form action="<?php echo site_url('admin/business/add_video');?>" method="post">
