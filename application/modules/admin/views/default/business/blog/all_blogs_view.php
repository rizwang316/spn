...
<div class="row">
  <div class="col-md-12">  
   ...
   <a href="<?php echo site_url('admin/business/blog_manage/'.$post_id);?>" class="btn btn-success add-location">Add New Blog Post</a>
   <div style="clear:both;margin-top:20px;"></div>
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i>All blog list</h3>
           ...
           <tbody>
        	...
        	<?php $i=1;foreach($blogs->result() as $row):  ?>
               ...
               <tr>
                  ...
                  <td data-title="<?php echo $row->title;?> " class="numeric"><?php echo $row->title;?>      </td>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a class="" href="<?php echo site_url('admin/business/blog_manage/'.$row->post_id.'/'.$row->id);?>"><?php echo lang_key('Edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/business/deleteblog/'.$curr_page.'/'.$post_id.'/'.$row->id.'/');?>"><?php echo lang_key('delete');?></a></li>                          
                      </ul>
               ...
               <tr>
               		<td colspan="2" class="numeric">&nbsp;</td>
                    <td><a class="btn btn-info" href="<?php echo site_url('admin/business/view_all_comments/'.$curr_page.'/'.$post_id.'/'.$row->id.'/');?>">View all review</a></td>
                   <td>&nbsp;</td>
