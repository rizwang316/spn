...
<div class="row">
  ...
  <div class="col-md-12">
   ...
   <a href="<?php echo site_url('admin/business/view_all_blogs/'. $curr_page.'/'.$this->uri->segment(5));?>" class="btn btn-success add-location"> << Back to blog list</a>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/business/deletecomment/'.$curr_page.'/'.$this->uri->segment(5).'/'.$post_id.'/'.$row->id.'/');?>"><?php echo lang_key('delete');?></a></li>                          
                      </ul>
