        	...
        	<?php $i=1;foreach($reviews->result() as $row):  ?>
               ...
               <tr>
                  ...
                  <td data-title="" class="numeric">
                  	 <?php if(get_all_review_single_thumb_count($row->id) > 0){ ?> 
                            <img src="<?php echo theme_url();?>/assets/images/single_thumb.png">
                        <?php  } ?>
                        <?php if(get_all_review_double_thumb_count($row->id) > 0){ ?>
                          <img src="<?php echo theme_url();?>/assets/images/double_thumb.png">
                        <?php } ?>
                        <?php  if(get_all_review_trophy_count($row->id) > 0){ ?>                        
                          <img src="<?php echo theme_url();?>/assets/images/trophy.png">
                        <?php } ?>
