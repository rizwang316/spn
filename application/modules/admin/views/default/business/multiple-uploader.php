...
<form id="uploader-form" action="<?php echo site_url('admin/business/uploadgalleryfile');?>" method="post" enctype="multipart/form-data" style="display:none">
    <input type="file" name="photoimg[]" id="photoimg" style="height:auto;" multiple>
</form>

<form id="featured-uploader-form" action="<?php echo site_url('admin/business/uploadfeaturedfile');?>" method="post" enctype="multipart/form-data" style="display:none">
    <input type="file" name="photoimg" id="photoimg_featured" style="height:auto;" >
</form>

<form id="logo-uploader-form" action="<?php echo site_url('admin/business/uploadlogofile');?>" method="post" enctype="multipart/form-data" style="display:none">
...
jQuery(document).ready(function(){
    ...
    jQuery('#photoimg_featured').change(function(){
            ...
            var uploadURL = '<?php echo site_url("admin/business/uploadfeaturedfile");?>'; //Upload URL
    ...
    jQuery('#photoimg_logo').change(function(){
            ...
            var uploadURL = '<?php echo site_url("admin/business/uploadlogofile");?>'; //Upload URL
            var extraData ={}; //Extra Data.
            var jqXHR=$.ajax({
                    xhr: function() {
                    var xhrobj = $.ajaxSettings.xhr();
