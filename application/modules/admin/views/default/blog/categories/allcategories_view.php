...
<div class="row">
  <div class="col-md-12">
    ...
    <a href="<?php echo site_url('admin/category_blog/newcategory');?>" class="btn btn-success add-location"><?php echo lang_key('new_category');?></a>
           ...
           <tbody>
        	<?php $i=1;foreach($posts->result() as $row):?>
               <tr>
                  ...
                  <td data-title="<?php echo lang_key('title');?>" class="numeric"><a href="<?php echo site_url('admin/category_blog/edit/'.$row->id);?>"><?php echo lang_key($row->title);?></a></td>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a href="<?php echo site_url('admin/category_blog/edit/'.$row->id);?>"><?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/category_blog/delete/'.$row->id);?>"><?php echo lang_key('delete');?></a></li>
                      </ul>
                    </div>
                  </td>
               </tr>
