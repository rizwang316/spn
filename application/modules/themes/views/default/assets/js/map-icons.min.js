...
MarkerLabel.prototype.onAdd = function() {
    var e = this.getPanes().overlayImage.appendChild(this.div),
        t = this;
...
MarkerLabel.prototype.onRemove = function() {
    ...
    for (var e = 0, t = this.listeners.length; e < t; ++e) google.maps.event.removeListener(this.listeners[e])
};
MarkerLabel.prototype.draw = function() {
    ...
    n.style.zIndex = this.get("zIndex");
