                    ...
                    <div class="shopping-checkout">
                        ...
                        <?php } ?>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"></label>
                                <div class="col-md-8">
                               <small> Click after you enter address </small> <i class="glyphicon glyphicon-arrow-right arrow-point-map"></i>
                ...
                <hr/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <small>The better the description of your business the better your local search engine results will be. Use unique content. 500 words or more is suggested.</small>
