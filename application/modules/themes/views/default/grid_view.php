        ...
        <div class="img-box-4-item">
            ...
            <div class="img-box-4-content">
                ...
                $class = "fa ";                
                 $class .= " bg-red";
                ?>
                <a class="b-tooltip" title="<?php echo get_category_title_by_id($post->category); ?>" href="<?php echo site_url('show/categoryposts/'.$post->category.'/'.dbc_url_title(get_category_title_by_id($post->category)));?>"><i class="category-fa-icon <?php echo $class;?>"></i></a>
