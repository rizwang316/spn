<?php
if($two_thumbs->num_rows()>0){ ?>
<div class="show-user-two-thumbs mediacls">
<h3>Two Thumbs</h3>
    <div class="col-sm-12">
     <div class="ajax-loading recent-user-two-thumbs-loading">
        <img src="<?php echo theme_url();?>/assets/img/loading.gif" alt="loading...">
    </div>
</div>
<?php
$i=1;
foreach($two_thumbs->result() as $review){
   ...
   <div class="reviewbox">   
     ...
     <div class="reviedetail">
      ...
      <table class="ratingcls">
                 <tr>
                        <?php /*?><?php if(get_all_post_single_thumb_count($post->id) > 0){ ?>
                       ...
                       <?php /*?> <?php if(get_all_post_trophy_count($post->id) > 0){ ?>
...
<?php } ?>
<div class="col-xs-12">  
    <div class="pagination-wrapper" id="pagination-two-thumbs">
