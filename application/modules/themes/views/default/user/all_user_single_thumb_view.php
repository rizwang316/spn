<?php
if($single_thumbs->num_rows()>0){ ?>
<div class="show-user-single-thumb mediacls">
<h3>Single Thumb</h3>
    <div class="col-sm-12">
     <div class="ajax-loading recent-user-single-thumb-loading">
        <img src="<?php echo theme_url();?>/assets/img/loading.gif" alt="loading...">
    </div>
</div>
<?php
$i=1;
foreach($single_thumbs->result() as $review){
