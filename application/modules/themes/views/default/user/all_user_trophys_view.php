<?php
if($trophys->num_rows()>0){ ?>
<div class="show-user-trophys mediacls">
<h3>Trophys</h3>
    <div class="col-sm-12">
     <div class="ajax-loading recent-user-trophy-loading">
        <img src="<?php echo theme_url();?>/assets/img/loading.gif" alt="loading...">
    </div>
</div>
<?php
$i=1;
foreach($trophys->result() as $review){
...
<?php } ?>
<div class="col-xs-12">  
    <div class="pagination-wrapper" id="pagination-trophy">
