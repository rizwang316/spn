<div class="commintblog" id="comments">
    ...
    <form action="<?php echo site_url("show/post_user_image_comments/");?>" class="comments-form"  method="post">  
    ...
    <label class="col-md-3 control-label">Comments:</label>
     ...
     <div class="col-md-6">
        <input type="hidden"  name="post_type" value="user_image" />
 ...
 <div class="view-all-image-comments"></div> 
  <div class="clearfix"></div>
...
<script type="text/javascript">
	...
	// laod all images comments.
	  var loadUrl = '<?php echo site_url("show/load_all_user_image_comments_view/".$image_id);?>';
        jQuery.post(
            loadUrl,
            {},
            function(responseText){
                jQuery('.view-all-image-comments').html(responseText);
                init_load_more_image_comments_js();
            }
        );
		
		 function init_load_more_image_comments_js()
         {
...
// add reply form click once time 
  $('.js-comments-reply').one('click',function(){  
			 ...
			 var html = '<div class="commintblog">'+
			 			<?php if(is_loggedin() && is_personal()){ ?>
			 			'<form action="<?php echo site_url("show/post_user_image_comments/");?>" class="comments-reply-form">'+	
							'<input type="hidden" name="user_id" value="<?=$this->session->userdata('user_id')?>"  />' +
						 '<div class="form-group">  '+
							 '<div class="col-md-12">'+
