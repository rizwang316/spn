...
<script src="<?php echo theme_url();?>/assets/js/select2.js"></script>
 ...
 <?php /*?> <form role="form" action="<?php echo site_url('search/top/')?>" method="get">  
        <div class="col-sm-6">     
        <div class="form-group">
              <div class="input-group">
                   <input class="form-control" type="text" placeholder="Search anything" name="s">
...
<?php */?>
    ...
    <form role="form" action="<?php echo site_url('show/advfilter')?>" method="post"> 
    		  ...
    		  <div class="col-sm-6">  
                    ...
                    <div class="col-sm-9">  
                    <select id="input-11" name="country" class="form-control chosen-select">
              ...
              <div class="col-sm-12">                
                   ...
                   <div class="col-sm-6"> 
                     ...
                     <div class="col-sm-9">  
                   		<input  class="form-control" type="text" placeholder="Search posts by title, or #" name="plainkey">
                     </div>  
