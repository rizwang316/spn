...
<div class="row">
                ...
                <div class="s-widget">
                    ...
                    <div class="widget-content search">
                        ...
                        <div class="form-group">
                          ...
                          <?php  $plainkey = (isset($data['plainkey']))?rawurldecode($data['plainkey']):'';
						  		  $plainkey = str_replace('hash_','#',$plainkey);						  
						  ?>
                            <input class="form-control" type="text" placeholder="Search posts by title, or #, Or anything" value="<?=$plainkey ?>" name="plainkey">
                        ...
                        <div class="form-group">                                           
                            ...
                            <option data-name="" value="any">Select Country</option>
                              <?php foreach (get_all_countries()->result() as $row) {
                                  $sel = ($row->id==$data['country'])?'selected="selected"':'';
                                  ?>
                                  <option data-name="<?php echo $row->name;?>" class="country city-<?php echo $row->parent;?>" value="<?php echo $row->id;?>" <?php echo $sel;?>><?php echo lang_key($row->name);?></option>
                              <?php }?>
                           </select>    
                        </div>
                         <div class="form-group">  
                         	 <select id="input-14" name="language" class="form-control chosen-select">
                        ...
                        <div class="form-group">
                            ...
                            <?php $options = array('id_asc','id_desc');?>
                        ...
                        <!-- Button -->
                        <button class="btn btn-green submit-search-button" type="submit"><?php echo lang_key('search');?></button>&nbsp;
    ...
    <div class="col-md-9 col-sm-9">
      <h5><span style="position:relative;top:12px; color:#80b13f; font-size:16px;"><?php echo lang_key('results'); ?></span>
        <div class="pull-right list-switcher">
          <a class="result-grid" href="#"></a>          
        </div>
      </h5>
...
jQuery(document).ready(function(){
  ...
  jQuery('#advance-search-form').submit(function(e){
    ...
    jQuery.post(
        ...
        function(result){          
           ...
           if(jQuery('.results > div > .blog-one-item').length<recent_count)
           {
  ...
  jQuery('.result-grid').click(function(e){	 
      ...
      var url = jQuery('#advance-search-form').attr('action');
      var action = url.replace('/list/','/list/');
