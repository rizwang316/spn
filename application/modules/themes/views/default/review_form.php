  ...
  <div class="writereview">
    <form id="review-form" method="post" action="<?php echo site_url('show/review/create_review');?>" role="form">
      ...
      <div class="col-sm-8 buright">
        ...
        <div class="ratingcl">
          <?php $v = (set_value('rating')!='')?set_value('rating'):'1';?>
          <label class="oneth">
            <input type="radio" name="rating"  <?php echo  ($v == 1)?'checked="checked"':'' ?>  value="1">
            <span></span> </label>
          <label class="twoth">
            <input type="radio" name="rating" <?php echo  ($v == 2)?'checked="checked"':'' ?>   value="2">
            <span></span> </label>
          <label class="trophy">
            
            <input type="radio" name="rating"  <?php echo ($v == 5)?'checked="checked"':'' ?>  value="5">
            <span></span> </label>
            <label class="shrug">
            
            <input type="radio" name="rating"  <?php echo ($v == 0)?'checked="checked"':'' ?>  value="0">
            <span></span> </label>
        </div>
