...
if ( ! function_exists('get_category_title_by_post_id'))
{
	function get_category_title_by_post_id($id='')
	{
		$categories = array();
		if($id==0)
			return 'No parent';
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('category_post_relationships',array('post_id'=>$id));
		if($query->num_rows()>0)
		{
			foreach($query->result() as $val){
				$query_category = $CI->db->get_where('categories',array('id'=>$val->category_id));
				if($query_category->num_rows()>0)
				{ 				 		
				   $categories[] = $query_category->row();
				}
			}			
		}
		return $categories;
...
if ( ! function_exists('get_all_business_map_data'))
{
    function get_all_business_map_data()
    {
        ...
        foreach ($query->result() as $row)
        {
            ...
            $post = array();
			$post['post_id'] 			= $row->id;
			$post['post_title'] 		= str_replace("'",'',$row->title);
			$post['post_purpose'] 		= '';
...
// paginaiton review.
if ( ! function_exists('get_all_review_count'))
{
	function get_all_review_count($post_id)
	{
...
if ( ! function_exists('get_all_post_reviews_pagination'))
{
	function get_all_post_reviews_pagination($post_id,$limit,$start)
	{
...
if ( ! function_exists('add_post_category'))
{
	function add_post_category ($post_id,$categories=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('category_post_relationships',array('post_id'=>$post_id));
		if($query->num_rows()>0)
		{
			$CI->db->delete('category_post_relationships',array('post_id'=>$post_id));
			foreach($categories as $cat){
				$CI->db->insert('category_post_relationships',array('post_id'=>$post_id,'category_id'=>$cat));
			}
		}
		else
		{
...
if ( ! function_exists('add_blog_category'))
{
	function add_blog_category ($post_id,$categories=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('category_blog_relationships',array('post_id'=>$post_id));
		if($query->num_rows()>0)
		{
			$CI->db->delete('category_blog_relationships',array('post_id'=>$post_id));
			foreach($categories as $cat){
				$CI->db->insert('category_blog_relationships',array('post_id'=>$post_id,'category_id'=>$cat));
			}
		}
		else
		{
...
if ( ! function_exists('get_category_title_by_blog_id'))
{
	function get_category_title_by_blog_id($id='')
	{
		$categories = array();
		if($id==0)
			return 'No parent';
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('category_blog_relationships',array('post_id'=>$id));
		if($query->num_rows()>0)
		{
			foreach($query->result() as $val){
				$query_category = $CI->db->get_where('categories_blog',array('id'=>$val->category_id));
				if($query_category->num_rows()>0)
				{ 				 		
				   $categories[] = $query_category->row();
				}
...
function get_all_blog_categories()
	{		
		$CI = get_instance();
		$CI->db->where('status',1); 
		$query = $CI->db->get('categories_blog');
		return $query;
	}
}
if ( ! function_exists('get_blog_category_id_by_slug'))
{
function get_blog_category_id_by_slug($slug)
	{
		
		$CI = get_instance();
		$query = $CI->db->get_where('categories_blog',array('slug'=>$slug));
		if($query->num_rows()<=0)
		{
...
// count trophy from post id.
if ( ! function_exists('get_all_post_trophy_count'))
{
	function get_all_post_trophy_count($post_id)
	{
       ...
       $CI->db->order_by('id', 'desc');
		$CI->db->where('post_id',$post_id);
		$CI->db->where('status',1);
		$CI->db->where('trophy',1);
		$query = $CI->db->get_where('review');
		return $query->num_rows();

	}
}
if ( ! function_exists('get_all_post_single_thumb_count'))
{
	function get_all_post_single_thumb_count($post_id)
	{
...
if ( ! function_exists('get_all_post_double_thumb_count'))
{
	function get_all_post_double_thumb_count($post_id)
	{
...
// count trophy from review id
if ( ! function_exists('get_all_review_trophy_count'))
{
	function get_all_review_trophy_count($review_id)
	{
...
if ( ! function_exists('get_all_review_single_thumb_count'))
{
	function get_all_review_single_thumb_count($review_id)
	{
...
if ( ! function_exists('get_all_review_double_thumb_count'))
{
	function get_all_review_double_thumb_count($review_id)
	{
...
// add more data in 
if ( ! function_exists('add_post_data'))
{
	function add_post_data($post_id,$key,$data=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('post_data',array('post_id'=>$post_id,'key'=>$key));
		if($query->num_rows()>0)
		{
			$CI->db->delete('post_data',array('post_id'=>$post_id,'key'=>$key));
			foreach($data as $val){
				$CI->db->insert('post_data',array('post_id'=>$post_id,'key'=>$key,'value'=>$val));
			}
		}
		else
		{
...
if ( ! function_exists('delete_post_data'))
{
	function delete_post_data($post_id,$key,$data=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('post_data',array('post_id'=>$post_id,'key'=>$key));
...
{
	function get_post_data($post_id,$key)
	{
		$CI = get_instance();
		$CI->load->database();
		$CI->db->order_by('id', 'desc');
		...
		$CI->db->where('key',$key);
		$CI->db->where('status',1);
		$query = $CI->db->get_where('post_data');
		return $query;
	}
}
// add post data general 
if ( ! function_exists('add_post_data_gen'))
{
	function add_post_data_gen($data=array())
	{
		$CI = get_instance();
		$CI->load->database();		
		$CI->db->insert('post_data',$data);
		$id = $CI->db->insert_id();
		return $id;
...
// update post data general 
if ( ! function_exists('update_post_data_gen'))
{
	function update_post_data_gen($id,$data=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('post_data',array('id'=>$id));
		if($query->num_rows()>0)
		{
			$CI->db->where('id', $id);		
			$CI->db->update('post_data',$data);
		}
		
	}
}
//delete
if ( ! function_exists('delete_post_data_gen'))
{
	function delete_post_data_gen($id)
	{
		$CI = get_instance();
		$CI->load->database();				
		$CI->db->delete('post_data',array('id'=>$id));		
...
if ( ! function_exists('add_user_meta_gen'))
{
	function add_user_meta_gen($user_id,$key,$data=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('user_meta',array('user_id'=>$user_id,'key'=>$key));
		if($query->num_rows()>0)
		{
			$CI->db->update('user_meta',$data,array('user_id'=>$user_id,'key'=>$key));
		}
		else
		{
			$CI->db->insert('user_meta',$data);
		}
	
	}
}

if ( ! function_exists('get_user_meta_gen'))
{
	function get_user_meta_gen($user_id,$key)
	{
		$CI = get_instance();
		$CI->load->database();
		$CI->db->order_by('id', 'desc');
		...
		$CI->db->where('key',$key);
		$CI->db->where('status',1);
		$query = $CI->db->get_where('user_meta');
		return $query;
	}
}
// get user data.
...
if ( ! function_exists('get_user_data'))
{
	function get_user_data($user_id,$key)
	{
		...
		$CI->db->where('key',$key);
		$CI->db->where('status',1);
		$query = $CI->db->get_where('user_data');
		return $query;
	}
}
// add user data general 
if ( ! function_exists('add_user_data_gen'))
{
	function add_user_data_gen($data=array())
	{
		$CI = get_instance();
		$CI->load->database();		
		$CI->db->insert('user_data',$data);
		$id = $CI->db->insert_id();
		return $id;
...
// update post data general 
if ( ! function_exists('update_user_data_gen'))
{
	function update_user_data_gen($id,$data=array())
	{
		$CI = get_instance();
		$CI->load->database();
		$query = $CI->db->get_where('user_data',array('id'=>$id));
		if($query->num_rows()>0)
		{
			$CI->db->where('id', $id);		
			$CI->db->update('user_data',$data);
		}
		
	}
}
if ( ! function_exists('get_user_data_gen'))
{
	function get_user_data_gen($user_id,$key)
	{
		$CI = get_instance();
		$CI->load->database();
		$CI->db->order_by('id', 'desc');
...
//delete
if ( ! function_exists('delete_user_data_gen'))
{
	function delete_user_data_gen($id)
	{
		$CI = get_instance();
		$CI->load->database();				
		$CI->db->delete('user_data',array('id'=>$id));		
...
// add more data in 
if ( ! function_exists('get_user_data_pagination'))
{
	function get_user_data_pagination($user_id,$key,$limit,$start)
	{
		$CI = get_instance();
		$CI->load->database();
		$CI->db->order_by('id', 'desc');
...
// count 
if ( ! function_exists('get_user_data_count'))
{
	function get_user_data_count($user_id,$key)
	{
...
// get user blog detail with slug 
if ( ! function_exists('get_user_blog_by_slug'))
{
	function get_user_blog_by_slug($slug)
	{
		$CI = get_instance();
		$CI->load->database();		
		$CI->db->where('slug',$slug);
		$CI->db->where('key','blog');
		$CI->db->where('status',1);		
		$query = $CI->db->get_where('user_data');
		return $query;
	}
...
// get user blog detail with slug 
if ( ! function_exists('get_business_blog_by_slug'))
{
	function get_business_blog_by_slug($slug)
	{
		$CI = get_instance();
		$CI->load->database();		
		$CI->db->where('slug',$slug);
...
// add more data in 
if ( ! function_exists('get_post_data_pagination'))
{
	function get_post_data_pagination($post_id,$key,$limit,$start)
	{
		$CI = get_instance();
		$CI->load->database();
		$CI->db->order_by('id', 'desc');
...
// count 
if ( ! function_exists('get_post_data_count'))
{
	function get_post_data_count($post_id,$key)
	{
...
// paginaiton review.
if ( ! function_exists('get_all_review_by_user_id_count'))
{
	function get_all_review_by_user_id_count($user_id)
	{
...
if ( ! function_exists('get_all_reviews_by_user_id_pagination'))
{
	function get_all_reviews_by_user_id_pagination($user_id,$limit,$start)
	{
...
// paginaiton trophy.
if ( ! function_exists('get_all_trophys_by_user_id_count'))
{
	function get_all_trophys_by_user_id_count($user_id)
	{
...
if ( ! function_exists('get_all_trophys_by_user_id_pagination'))
{
	function get_all_trophys_by_user_id_pagination($user_id,$limit,$start)
	{
...
// paginaiton two thumbs.
if ( ! function_exists('get_all_two_thumbs_by_user_id_count'))
{
	function get_all_two_thumbs_by_user_id_count($user_id)
	{
...
if ( ! function_exists('get_all_two_thumbs_by_user_id_pagination'))
{
	function get_all_two_thumbs_by_user_id_pagination($user_id,$limit,$start)
	{
...
// paginaiton single thumb.
if ( ! function_exists('get_all_single_thumb_by_user_id_count'))
{
	function get_all_single_thumb_by_user_id_count($user_id)
	{
...
if ( ! function_exists('get_all_single_thumb_by_user_id_pagination'))
{
	function get_all_single_thumb_by_user_id_pagination($user_id,$limit,$start)
	{
...
// get post data by unique id.
if ( ! function_exists('get_post_by_unique_id'))
{
...
// get profile 
if ( ! function_exists('get_all_education_by_user_id'))
{
	function get_all_education_by_user_id($user_id)
	{
		$CI = get_instance();
		$CI->db->order_by('id', "desc");
		$CI->db->where('user_id',$user_id); 
		$CI->db->where('status',1); 
		$query = $CI->db->get('user_education');
		return $query;
	}
}
if ( ! function_exists('get_all_experience_by_user_id'))
{
	function get_all_experience_by_user_id($user_id)
	{
		$CI = get_instance();
		$CI->db->order_by('id', "desc");
		$CI->db->where('user_id',$user_id); 
		$CI->db->where('status',1); 
		$query = $CI->db->get('user_experience');
		return $query;
	}
}

if ( ! function_exists('get_random_general_blog'))
{
	function get_random_general_blog($limit)
	{
		$CI = get_instance();
...
if ( ! function_exists('get_random_business_blog'))
{
	function get_random_business_blog($limit)
	{
		$CI = get_instance();
		$CI->db->order_by('id', 'RANDOM');
		$CI->db->where('key','blog'); 
		$CI->db->where('status',1); 
		$CI->db->limit($limit);
		$query = $CI->db->get('post_data');
		return $query;
	}
}
if ( ! function_exists('get_random_user_blog'))
{
	function get_random_user_blog($limit)
	{
		$CI = get_instance();
		$CI->db->order_by('id', 'RANDOM');
		$CI->db->where('key','blog'); 
		$CI->db->where('status',1); 
		$CI->db->limit($limit);
		$query = $CI->db->get('user_data');
		return $query;
	}
}

if ( ! function_exists('get_random_business_video'))
{
	function get_random_business_video($limit)
	{
		$CI = get_instance();
		$CI->db->order_by('id', 'RANDOM');
		$CI->db->where('key','video_url'); 
		$CI->db->where('status',1); 
		$CI->db->limit($limit);
		$query = $CI->db->get('post_data');
		return $query;
...
// 
if ( ! function_exists('get_random_user_video'))
{
	function get_random_user_video($limit)
	{
		$CI = get_instance();
		$CI->db->order_by('id', 'RANDOM');
		$CI->db->where('key','video_url'); 
